...
( function( root ) {
    ...
    root.h8.charts.register('column',function( el ) {
        ...
        return {
            ...
            values: function( values, reset ) {
                ...
                if ( !size ) {
                    if ( !( size = filtered = _.size( values ) ) ) return;
                    if ( !multiLegend ) {
                        _.defer( function() { container.select( '.nv-multiBarWithLegend' ).classed( 'single-legend', true ); } );
                        chart.showControls( false ).showLegend( false ).margin( { top: 10 } );
                    }
                }
                if ( colors ) {
            ...
            staggerLabels: function(flag){
                chart.staggerLabels(flag);
                return this;
            },
            rotateLabels: function(r){
                chart.rotateLabels(r);
                return this;
            }
